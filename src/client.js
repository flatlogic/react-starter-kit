...
function run() {
  const scrollOffsets = Object.create(null);
  ...
  const unlisten = Location.listen(location => {
    ...
    if (!scrollOffsets[locationId]) {
      scrollOffsets[locationId] = Object.create(null);
    }
    currentScrollOffset = scrollOffsets[location.pathname];
